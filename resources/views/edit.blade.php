                ...
                <a href="{{route('tampil')}}" class="btn btn-primary">Kembali</a>
                    ...
                    <form class="row g-3" method="post">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" value="<?php echo 'Teguh Wandala' ?>" id="name" name="name" placeholder="Nama Lengkap">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" class="form-control" id="email" name="email" value="<?php echo 'teguhwandala@gmail.com' ?>" placeholder="name@examples.com">
                        </div>
                        <div class="col-md-6">
                            <label for="phone" class="form-label">Telp</label>
                            <input type="number" class="form-control" id="phone" name="phone" value="<?php echo '087765904262' ?>" placeholder="08xxxx">
                        </div>
                        <div class="col-12">
                            <label for="address" class="form-label">Alamat</label>
                            <input type="text" class="form-control" id="address" name="address" value="<?php echo 'Narmada' ?>" placeholder="Masukkan Alamat Lengkap">
                        </div>
                        <div class="mb-3">
